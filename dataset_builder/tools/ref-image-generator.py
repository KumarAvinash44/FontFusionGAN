...
DEFAULT_LABEL_FILE = os.path.join(SCRIPT_PATH,
                                  '../labels/seen_chinese_chars.txt')
DEFAULT_FONTS_DIR = os.path.join(SCRIPT_PATH, '../CHN_src_font')
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, '../../dataset')
...
def generate_hangul_images(label_file, fonts_dir, output_dir):
    ...
    image_dir = os.path.join(output_dir, 'seen_src_imgs')
