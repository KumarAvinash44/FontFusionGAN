        ...
        if get_rank() == 0:
            ...
            if i % 50 == 0:
                with torch.no_grad():
                    ...
                    utils.save_image(
                        sample,
                        # You need to edit
                        f"sample/fineTune_2350_4000/{str(i).zfill(6)}.png",
            ...
            if i % 400 == 0:
                torch.save(
                    ...
                    # You need to edit
                    f"checkpointTest/{str(i).zfill(6)}.pt",
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default='dataset/train_fine', help="path to the dataset")
    parser.add_argument('--arch', type=str, default='stylegan2', help='model architectures (stylegan2 | swagan)')
    parser.add_argument(
        "--iter", type=int, default=6000, help="total training iterations"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        # default=None,
        default="checkpointTest/korean_2350.pt",
